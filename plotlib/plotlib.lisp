...
(print (list "****  *current-directory*=" *current-directory-pl*))
...
(defun plot-string(x y str)
  (let ((font (get-font (concatenate 'string *current-directory-pl* "OpenSans-Regular.ttf"))))
    (set-font font 12)
    (set-rgb-fill 0 0 0)
    (draw-string x y str)))

(defun plot-string-bold(x y str)
  (let ((font (get-font (concatenate 'string *current-directory-pl* "OpenSans-Bold.ttf"))))
    (set-font font 12)
    (set-rgb-fill 0 0 0)
    (draw-string x y str)))
